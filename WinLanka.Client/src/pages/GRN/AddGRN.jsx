...
function AddGRN() {
    ...
    const handleSubmit = (event) => {
        ...
        console.log("GRN data:", submissionData);
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-section">
                        <div className="form-section-header">
                            ...
                            <p>
                                Enter the supplier and date for this goods
                                received note.
                            </p>
                        </div>
                    ...
                    <div className="form-section">
                        <div className="line-items-header">
                            <div className="form-section-header">
                                <h2>Stock Items Received</h2>
                                <p>
                                    Add all stock items included in this GRN.
                                </p>
                            </div>
